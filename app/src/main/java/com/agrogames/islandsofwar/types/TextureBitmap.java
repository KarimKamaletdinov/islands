...
public enum TextureBitmap {
    ...
    AirDefence("air-defence.png"),
    AirDefenceTower("air-defence-tower.png"),
    ...
    Bomber("bomber.png"),
    BomberPicture("bomber-picture.png"),
    BomberDestroyed("bomber-destroyed.png"),
