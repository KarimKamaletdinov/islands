...
public class GameObjectRenderer {
    public static float render(RenderableObject object, TextureDrawer drawer, ObjectState state){
        RenderableTexture texture = TextureProvider.getTexture(object, state);
    ...
    public static float render(RenderableObject object, TextureDrawer drawer){
        return render(object, drawer, ObjectState.Normal);
    }
}
